...
#   timestamp: 2024-06-21T14:01:22+00:00
...
class AuthoringEntityItem(SchemaBaseModel):
    name: str = Field(
        ...,
        description=(
            "Name of the person, corporate body, or agency responsible for the work's"
            " substantive and intellectual content. If a person, invert first and last"
            " name and use commas."
        ),
        title="Agency Name",
    )
...
class DataCollection(SchemaBaseModel):
    """
    This description should include, when applicable, the sample frame used, the questions used to collect the data, the
    type of interview, the dates/duration of fieldwork, the sample size and the response rate. Some additional
    information on questionnaire design and testing, interviewer training, methods used to monitor non-response etc.
    """
...
class SeriesDescription(SchemaBaseModel):
    ...
    data_collection: Optional[DataCollection] = Field(
        None,
        description=(
            " This description should include, when applicable, the sample frame used,"
            " the questions used to collect the data, the type of interview, the"
            " dates/duration of fieldwork, the sample size and the response rate. Some"
            " additional information on questionnaire design and testing, interviewer"
            " training, methods used to monitor non-response etc."
        ),
    ...
    adjustments: Optional[List[str]] = Field(
        None,
        description=(
            " Description of any adjustments with respect to use of standard"
            " classifications and harmonization of breakdowns for age group and other"
            " dimensions, or adjustments made for compliance with specific"
    ...
    geographic_units: Optional[List[GeographicUnit]] = Field(
        None,
        description=(
            "List of geographic units (regions, countries, states, provinces, etc.) for"
            " which data are available in the database."
        ),
