...
#   filename:  survey-schema.json
#   timestamp: 2024-06-24T14:21:03+00:00
...
class DatafileSchema(SchemaBaseModel):
    ...
    file_type: Optional[str] = Field(
        ...
        description=(
            ...
            " software-dependent files such as SAS datasets, SPSS export files, etc."
        ),
        title="File type",
    )
...
class VarStdCatgry(SchemaBaseModel):
    ...
    The attribute `date` is provided to indicate the version of the code in place at the time of the study.
    The attribute `URI` is provided to indicate a URN or URL that can be used to obtain an electronic list of the
        category codes.
    """
...
class VarFormat(SchemaBaseModel):
    """
    The technical format of the variable in question. Attributes for this element include:
    'type', which indicates if the variable is character or numeric;
    'formatname,' which in some cases may provide the name of the particular, proprietary format actually used;
    'schema,' which identifies the vendor or standards body that defined the format (acceptable choices are SAS, SPSS,
        IBM, ANSI, ISO, XML-data or other);
...
class VariableSchema(SchemaBaseModel):
    ...
    var_imputation: Optional[str] = Field(
        None,
        description=(
            "According to the Statistical Terminology glossary maintained by the"
            " National Science Foundation, this is `the process by which one estimates"
            " missing values for items that a survey respondent failed to provide,` and"
            " if applicable in this context, it refers to the type of procedure used. "
        ),
        title="Imputation",
    )
    var_derivation: Optional[str] = Field(
        ...
        description=(
            ...
            " variables in the study used to generate the derivation. The `var`"
            " attribute provides the ID values of the other variables in the study used"
            " to generate this derived variable."
        ),
        title="Derivation",
    )
    ...
    var_forward: Optional[str] = Field(
        None,
        description=(
            "Contains a reference to IDs of possible following questions. This can be"
            " used to document forward skip instructions."
        ),
        title="Forward skip",
    )
    var_backward: Optional[str] = Field(
        None,
        description=(
            "Contains a reference to IDs of possible preceding questions. This can be"
            " used to document backward skip instructions."
        ),
        title="Backward skip",
    )
    ...
    var_sumstat: Optional[List[VarSumstatItem]] = Field(
        None,
        description=(
            "One or more statistical measures that describe the responses to a"
            " particular variable and may include one or more standard summaries, e.g.,"
            " minimum and maximum values, median, mode, etc. \n\n The attribute 'type'"
            " denotes the type of statistics being shown: mean, median, mode, valid"
    ...
    var_std_catgry: Optional[VarStdCatgry] = Field(
        None,
        description=(
            "Standard category codes used in the variable, like industry codes,"
            " employment codes, or social class codes. The attribute `date` is provided"
            " to indicate the version of the code in place at the time of the study."
            " The attribute `URI` is provided to indicate a URN or URL that can be used"
            " to obtain an electronic list of the category codes."
        ),
    ...
    var_format: Optional[VarFormat] = Field(
        None,
        description=(
            "The technical format of the variable in question. Attributes for this"
            " element include: 'type', which indicates if the variable is character or"
            " numeric; 'formatname,' which in some cases may provide the name of the"
            " particular, proprietary format actually used; 'schema,' which identifies"
            " the vendor or standards body that defined the format (acceptable choices"
            " are SAS, SPSS, IBM, ANSI, ISO, XML-data or other); 'category,' which"
            " describes what kind of data the format represents, and includes date,"
            " time, currency, or 'other' conceptual possibilities."
        ),
...
class TitleStatement(SchemaBaseModel):
    ...
    idno: str = Field(
        ...,
        description=(
            "The ID number of a dataset is a unique number that is used to identify a"
            " particular survey. Define and use a consistent scheme to use. Such an ID"
            " could be constructed as follows: country-producer-survey-year-version"
            " where \n - country is the 3-letter ISO country abbreviation \n - producer"
            " is the abbreviation of the producing agency \n - survey is the survey"
            " abbreviation \n - year is the reference year (or the year the survey"
            " started) \n - version is the number dataset version number (see Version"
            " Description below)"
        ),
    ...
    title: str = Field(
        ...,
        description=(
            "The title is the official name of the survey as it is stated on the"
            " questionnaire or as it appears in the design documents. The following"
            " items should be noted:\n - Include the reference year(s) of the survey in"
            " the title. \n - Do not include the abbreviation of the survey name in the"
            " title. \n - As the survey title is a proper noun, the first letter of"
            " each word should be capitalized (except for prepositions or other"
    ...
    alternate_title: Optional[str] = Field(
        None,
        description=(
            "The abbreviation of a survey is usually the first letter of each word of"
            " the titled survey. The survey reference year(s) may be included."
        ),
    ...
    translated_title: Optional[str] = Field(
        None,
        description=(
            "In countries with more than one official language, a translation of the" " title may be provided."
        ),
...
class ProductionStatement(SchemaBaseModel):
    ...
    prod_date: Optional[str] = Field(
        None,
        description=(
            "Date when the marked-up document/marked-up document source/data"
            " collection/other material(s) were produced (not distributed or archived)."
            " The ISO standard for dates (YYYY-MM-DD) is recommended for use with the"
            " date attribute. Production date for data collection (2.1.3.3) maps to"
    ...
    funding_agencies: Optional[List[FundingAgency]] = Field(
        None,
        description=(
            "The source(s) of funds for production of the work. If different funding"
...
class DistributionStatement(SchemaBaseModel):
    ...
    distributors: Optional[List[Distributor]] = Field(
        ...
        description=(
            ...
            " Names and addresses may be specified and other archives may be"
            " co-distributors. A URI attribute is included to provide an URN or URL to"
            " the ordering service or download facility on a Web site."
        ),
        title="Distributor",
    )
...
class SeriesStatement(SchemaBaseModel):
    ...
    series_info: Optional[str] = Field(
        None,
        description=(
            "A survey may be repeated at regular intervals (such as an annual labour"
            " force survey), or be part of an international survey program (such as the"
            " MICS, CWIQ, DHS, LSMS and others). The Series information is a"
            " description of this `collection` of surveys. A brief description of the"
            " characteristics of the survey, including when it started, how many rounds"
            " were already implemented, and who is in charge would be provided here."
        ),
...
class BoundPolyItem(SchemaBaseModel):
    lat: Optional[str] = Field(
        None,
        description=(
            "Latitude (y coordinate) of a point. Valid range expressed in decimal"
            " degrees is as follows: -90,0 to 90,0 degrees (latitude)"
        ),
        title="Latitude",
    )
    lon: Optional[str] = Field(
        None,
        description=(
            "Longitude (x coordinate) of a point. Valid range expressed in decimal"
            " degrees is as follows: -180,0 to 180,0 degrees (longitude)"
        ),
        title="longitude",
    )
...
class QualityStatement(SchemaBaseModel):
    """
    The quality statement provides elements to describe compliance with quality standards in the form of a statement and
    an itemized list of standards complied with, and an element to provide other quality statement.
    """
...
class ExPostEvaluation(SchemaBaseModel):
    """
    This structure consists of two parts, standardsCompliance and otherQualityStatements. In standardsCompliance list
    all specific standards complied with during the execution of this study. Note the standard name and producer and how
    the study complied with the standard. Enter any additional quality statements in otherQualityStatements.
    """
...
class StudyInfo(SchemaBaseModel):
    """
    This section contains information about the data collection's scope across several dimensions, including substantive
    content, geography, and time.
    """

    study_budget: Optional[str] = Field(
        None,
        description=(
            "Provide a clear summary of the pDescribe the budget of the project in as"
            " much detail as needed. Use XHTML structure elements to identify discrete"
            " pieces of information in a way that facilitates direct transfer of"
            " information on the study budget between DDI 2 and DDI 3"
            " structures.urposes, objectives and content of the survey"
        ),
        title="Study Budget",
    )
    ...
    time_periods: Optional[List[TimePeriod]] = Field(
        None,
        description=(
            "This field will usually be left empty. Time period differs from the dates"
            " of collection as they represent the period for which the data collected"
    ...
    coll_dates: Optional[List[CollDate]] = Field(
        None,
        description=(
            "Enter the dates (at least month and year) of the start and end of the data"
            " collection. In some cases, data collection for a same survey can be"
            " conducted in waves. In such case, you should enter the start and end date"
            " of each wave separately, and identify each wave in the 'cycle' field."
        ),
    ...
    nation: List[NationItem] = Field(
        ...,
        description=(
            "Indicates the country or countries covered in the file. Field"
            " `abbreviation` may be used to list common abbreviations; use of ISO"
            " country codes is recommended. Maps to Dublin Core Coverage element."
    ...
    bound_poly: Optional[List[BoundPolyItem]] = Field(
        None,
        description=(
            "This field allows the creation of multiple polygons to describe in a more"
            " detailed manner the geographic area covered by the dataset. It should"
            " only be used to define the outer boundaries of a covered area. For"
            " example, in the United States, such polygons can be created to define"
            " boundaries for Hawaii, Alaska, and the continental United States, but not"
            " interior boundaries for the contiguous states. This field is used to"
            " refine a coordinate-based search, not to actually map an area. \nIf the"
            " boundPoly element is used, then geoBndBox MUST be present, and all points"
            " enclosed by the boundPoly MUST be contained within the geoBndBox."
            " Elements westBL, eastBL, southBL, and northBL of the geoBndBox should"
            " each be represented in at least one point of the boundPoly description."
        ),
    ...
    geog_coverage: Optional[str] = Field(
        None,
        description=(
            " Information on the geographic coverage of the data. Includes the total"
            " geographic scope of the data, and any additional levels of geographic"
            " coding provided in the variables. Maps to Dublin Core Coverage element."
    ...
    analysis_unit: Optional[str] = Field(
        ...
        description=(
            ...
            " individuals, families/households, groups, facilities,"
            " institutions/organizations, administrative units, physical locations,"
            " etc."
        ),
    ...
    universe: Optional[str] = Field(
        None,
        description=(
            "We are interested here in the survey universe (not the universe of"
            " particular sections of the questionnaires or variables), i.e. in the"
            " identification of the population of interest in the survey. The universe"
            " will rarely be the entire population of the country. Sample household"
            " surveys, for example, usually do not cover homeless, nomads, diplomats,"
            " community households. Some surveys may cover only the population of a"
            " particular age group, or only male (or female), etc."
        ),
        title="Universe",
    )
    ...
    quality_statement: Optional[QualityStatement] = Field(
        None,
        description=(
            "The quality statement provides elements to describe compliance with"
            " quality standards in the form of a statement and an itemized list of"
            " standards complied with, and an element to provide other quality"
            " statement."
        ),
    ...
    ex_post_evaluation: Optional[ExPostEvaluation] = Field(
        None,
        description=(
            "This structure consists of two parts, standardsCompliance and"
            " otherQualityStatements. In standardsCompliance list all specific"
            " standards complied with during the execution of this study. Note the"
            " standard name and producer and how the study complied with the standard."
...
class Resource(SchemaBaseModel):
    ...
    origin: Optional[str] = Field(
        None,
        description=(
            "For historical materials, information about the origin(s) of the sources"
            " and the rules followed in establishing the sources should be specified."
    ...
    characteristics: Optional[str] = Field(
        None,
        description=(
            "Assessment of characteristics and quality of source material. May not be" " relevant to survey data."
        ),
...
class StudyDevelopment(SchemaBaseModel):
    ...
    a controlled vocabulary. Describe the activity, listing participants with their role and affiliation, resources used
    (sources of information), and the outcome of the development activity.
    """
...
class FrameUnit(SchemaBaseModel):
    """
    Provides information about the sampling frame unit. The attribute `isPrimary` is boolean, indicating whether the
    unit is primary or not.
    """
    ...
    unit_type: Optional[str] = Field(
        None,
        description=(
            "Describes the type of sampling frame unit. The field `num_of_units`"
            " provides the number of units in the sampling frame."
        ),
        title="Unit Type",
    )
...
class SampleFrame(SchemaBaseModel):
    ...
    Sample frame describes the sampling frame used for identifying the population from which the sample was taken.
        For example, a telephone book may be a sample frame for a phone survey. In addition to the name, label and text
        describing the sample frame, this structure lists who maintains the sample frame, the period for which it is
        valid, a use statement, the universe covered, the type of unit contained in the frame as well as the number of
        units available, the reference period of the frame and procedures used to update the frame.
    """
    ...
    custodian: Optional[str] = Field(
        None,
        description=(
            "Custodian identifies the agency or individual who is responsible for"
            " creating or maintaining the sample frame."
        ),
        title="Custodian",
    )
    universe: Optional[str] = Field(
        ...
        description=(
            ...
            " to which any analytic results refer."
        ),
        title="Universe",
    )
    frame_unit: Optional[FrameUnit] = Field(
        None,
        description=(
            "Provides information about the sampling frame unit. The attribute"
            " `isPrimary` is boolean, indicating whether the unit is primary or not."
        ),
        title="Frame unit",
    )
    reference_period: Optional[List[ReferencePeriodItem]] = Field(
        None,
        description=(
            "Indicates the period of time in which the sampling frame was actually used"
            " for the study in question. Use ISO 8601 date/time formats to enter the"
            " relevant date(s)."
        ),
...
class DataCollection(SchemaBaseModel):
    ...
    time_method: Optional[str] = Field(
        None,
        description=(
            "The time method or time dimension of the data collection. Examples: `panel"
            " survey`, `h>cross-section`, `trend study`, `time-series`"
        ),
        title="Time Method",
    )
    data_collectors: Optional[List[DataCollector]] = Field(
        None,
        description=(
            "The persons and/or agencies that took charge of the data collection. This"
            " element includes 3 fields: Name, Abbreviation and the Affiliation. In"
            " most cases, we will record here the name of the agency, not the name of"
            " interviewers. Only in the case of very small-scale surveys, with a very"
            " limited number of interviewers, the name of person will be included as"
            " well. The field Affiliation is optional and not relevant in all cases."
        ),
    ...
    collector_training: Optional[List[CollectorTrainingItem]] = Field(
        None,
        description=(
            "Describes the training provided to data collectors including interviewer"
            " training, process testing, compliance with standards etc. This is"
            " repeatable for language and to capture different aspects of the training"
            " process. The type attribute allows specification of the type of training"
            " being described."
        ),
    ...
    frequency: Optional[str] = Field(
        None,
        description=(
            "For data collected at more than one point in time, the frequency with"
            " which the data were collected. Examples `monthly`, `quarterly`, `yearly`"
        ),
    ...
    sampling_procedure: Optional[str] = Field(
        None,
        description=(
            "The type of sample and sample design used to select the survey respondents"
            " to represent the population. \nThis field only applies to sample surveys."
            " Information on sampling procedure is crucial (although not applicable for"
            " censuses and administrative datasets). Examples `National multistage area"
            " probability sample`, `Simple random sample`, `Quota sample`"
        ),
    ...
    sample_frame: Optional[SampleFrame] = Field(
        None,
        description=(
            "Sample frame describes the sampling frame used for identifying the"
            " population from which the sample was taken. For example, a telephone book"
            " may be a sample frame for a phone survey. In addition to the name, label"
            " and text describing the sample frame, this structure lists who maintains"
            " the sample frame, the period for which it is valid, a use statement, the"
            " universe covered, the type of unit contained in the frame as well as the"
            " number of units available, the reference period of the frame and"
            " procedures used to update the frame."
        ),
        title="Sample Frame",
    )
    sampling_deviation: Optional[str] = Field(
        ...
        description=(
            ...
            " field requires a deviation from the sampling design (for example due to"
            " difficulty to access to zones due to weather problems, political"
            " instability, etc). If for any reason, the sample design has deviated,"
    ...
    coll_mode: Optional[List[str]] = Field(
        None,
        description=(
            "The mode of data collection is the manner in which the interview was"
            " conducted or information was gathered.  In most cases, the response will"
            " be 'face to face interview'. But for some specific kinds of datasets,"
            " such as for example data on rain fall, the response will be different."
        ),
    ...
    research_instrument: Optional[str] = Field(
        None,
        description=(
            "The type of data collection instrument used. \n`Structured` indicates an"
            " instrument in which all respondents are asked the same questions/tests,"
            " possibly with precoded answers. If a small portion of such a"
            " questionnaire includes open-ended questions, provide appropriate"
            " comments. \n`Semi-structured` indicates that the research instrument"
            " contains mainly open-ended questions. \n`Unstructured` indicates that"
    ...
    instru_development: Optional[str] = Field(
        None,
        description=(
            "Describe any development work on the data collection instrument. Type"
            " attribute allows for the optional use of a defined development type with"
            " or without use of a controlled vocabulary."
        ),
    ...
    sources: Optional[List[Source]] = Field(
        None,
        description=(
            "Description of sources used for the data collection. The element is"
            " nestable so that the sources statement might encompass a series of"
            " discrete source statements, each of which could contain the facts about"
            " an individual source. This element maps to Dublin Core Source element."
        ),
        title="Sources",
    )
    coll_situation: Optional[str] = Field(
        None,
        description=(
            "Description of noteworthy aspects of the data collection situation."
            " Includes information on factors such as cooperativeness of respondents,"
            " duration of interviews, number of call-backs, etc."
        ),
    ...
    act_min: Optional[str] = Field(
        None,
        description=(
            "Summary of actions taken to minimize data loss. Includes information on"
            " actions such as follow-up visits, supervisory checks, historical"
            " matching, estimation, etc."
        ),
        title="Supervision",
    )
    control_operations: Optional[str] = Field(
        None,
        description=(
            " Methods to facilitate data control performed by the primary investigator"
            " or by the data archive. Specify any special programs used for such"
            " operations."
        ),
    ...
    weight: Optional[str] = Field(
        None,
        description=(
            "The use of sampling procedures may make it necessary to apply weights to"
            " produce accurate statistical results. Describe here the criteria for"
    ...
    cleaning_operations: Optional[str] = Field(
        None,
        description=(
            "Methods used to `clean` the data collection, e.g., consistency checking," " wildcode checking, etc."
        ),
...
class AnalysisInfo(SchemaBaseModel):
    ...
    data_appraisal: Optional[str] = Field(
        None,
        description=(
            "Other issues pertaining to data appraisal. Describe here issues such as"
            " response variance, nonresponse rate and testing for bias, interviewer and"
            " response bias, confidence levels, question bias, etc."
        ),
...
class CodingInstruction(SchemaBaseModel):
    ...
    command: Optional[str] = Field(
        None,
        description=(
            "Provide command code for the coding instruction. The formalLanguage"
            " attribute identifies the language of the command code."
        ),
        title="Command",
    )
...
class Method(SchemaBaseModel):
    ...
    study_class: Optional[Union[str, List[Any]]] = Field(
        None,
        description=(
            "Generally used to give the data archive's class or study status number,"
            " which indicates the processing status of the study. May also be used as a"
            " text field to describe processing status. Example: `DDA Class C`, `Study"
            " is available from http://example.com` "
        ),
    ...
    data_processing: Optional[List[DataProcessingItem]] = Field(
        None,
        description=(
            "Describes various data processing procedures not captured elsewhere in the"
            " documentation, such as topcoding, recoding, suppression, tabulation, etc."
            " The `type` attribute supports better classification of this activity,"
            " including the optional use of a controlled vocabulary"
        ),
...
class DatasetAvailability(SchemaBaseModel):
    ...
    access_place: Optional[str] = Field(
        None,
        description=(
            "Location where the data collection is currently stored. Use the URL field"
            " `access_place_url` to provide a URN or URL for the storage site or the"
    ...
    access_place_url: Optional[str] = Field(
        None,
        description=(
            "Location where the data collection is currently stored. Provide a URN or"
            " URL for the storage site or the actual address from which the data may be"
            " downloaded"
        ),
    ...
    status: Optional[str] = Field(
        None,
        description=(
            "Statement of collection availability. An archive may need to indicate that"
            " a collection is unavailable because it is embargoed for a period of time,"
            " because it has been superseded, because a new edition is imminent, etc."
        ),
    ...
    coll_size: Optional[str] = Field(
        None,
        description=(
            "Summarizes the number of physical files that exist in a collection,"
            " recording the number of files that contain data and noting whether the"
            " collection contains machine-readable documentation and/or other"
    ...
    complete: Optional[str] = Field(
        None,
        description=(
            "This item indicates the relationship of the data collected to the amount"
            " of data coded and stored in the data collection. Information as to why"
            " certain items of collected information were not included in the data file"
            " stored by the archive should be provided"
        ),
...
class DatasetUse(SchemaBaseModel):
    ...
    conf_dec: Optional[List[ConfDecItem]] = Field(
        None,
        description=(
            " This element is used to determine if signing of a confidentiality"
            " declaration is needed to access a resource."
        ),
    ...
    restrictions: Optional[str] = Field(
        None,
        description=(
            "Any restrictions on access to or use of the collection such as privacy"
            " certification or distribution restrictions should be indicated here."
            " These can be restrictions applied by the author, producer, or"
            " disseminator of the data collection. If the data are restricted to only a"
    ...
    cit_req: Optional[str] = Field(
        None,
        description=(
            "Text of requirement that a data collection should be cited properly in"
    ...
    deposit_req: Optional[str] = Field(
        None,
        description=(
            "Information regarding user responsibility for informing archives of their"
            " use of data through providing citations to the published work or"
            " providing copies of the manuscripts."
        ),
    ...
    conditions: Optional[str] = Field(
        ...
        description=(
            ...
            " understanding the access and use conditions of the data collection."
        ),
        title="Conditions",
    )
...
class StudyDesc(SchemaBaseModel):
    ...
    authoring_entity: Optional[List[AuthoringEntityItem]] = Field(
        None,
        description=(
            "The person, corporate body, or agency responsible for the work's"
            " substantive and intellectual content. Repeat the element for each author,"
            " and use 'affiliation' attribute if available. Invert first and last name"
            " and use commas."
        ),
    ...
    oth_id: Optional[List[OthIdItem]] = Field(
        None,
        description=(
            "Acknowledge any other people and institutions that have in some form" " contributed to the survey"
        ),
    ...
    bib_citation: Optional[str] = Field(
        None,
        description=(
            "Complete bibliographic reference containing all of the standard elements"
            " of a citation that can be used to cite the work. The"
            " `'bib_citation_format'` field is provided to enable specification of the"
            " particular citation style used, e.g., APA, MLA, Chicago, etc."
        ),
    ...
    holdings: Optional[List[Holding]] = Field(
        None,
        description=(
            "Information concerning either the physical or electronic holdings of the"
            " cited work. Attributes include: location--The physical location where a"
            " copy is held; callno--The call number for a work at the location"
            " specified; and URI--A URN or URL for accessing the electronic copy of the"
            " cited work."
        ),
    ...
    study_authorization: Optional[StudyAuthorization] = Field(
        None,
        description=(
            "Provides structured information on the agency that authorized the study,"
            " the date of authorization, and an authorization statement"
        ),
    ...
    study_info: StudyInfo = Field(
        ...,
        description=(
            "This section contains information about the data collection's scope across"
            " several dimensions, including substantive content, geography, and time."
        ),
        title="Study Scope",
    )
    study_development: Optional[StudyDevelopment] = Field(
        ...
        description=(
            ...
            " Describe the activity, listing participants with their role and"
            " affiliation, resources used (sources of information), and the outcome of"
...
class DdiSchema(SchemaBaseModel):
    """
    Schema for Survey data type based on DDI 2.5
    """
...
class SurveyMicrodataSchema(DdiSchema):
    """
    Schema for Survey data type based on DDI 2.5
    """
